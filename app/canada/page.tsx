...
export const metadata: Metadata = {
  ...
  keywords: [
    "premium IPTV packages Canada",
    "IPTV Canada",
    "NHL live stream package",
    "Canada soccer IPTV",
    "best Canadian sports streams",
    "IPTV Canada soccer"
  ],
};

export default function CanadaPage() {
  const whatsappMsg = `Hello! I am viewing your Canada premium package portal and would like to get a quote and channel guide.`;
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16 space-y-16">
      ...
      <div className="relative rounded-3xl overflow-hidden bg-gradient-to-tr from-primary/10 via-card-bg to-accent/5 border border-card-border p-8 md:p-12">
        ...
        <div className="relative z-10 max-w-3xl space-y-6">
          <div className="inline-flex items-center space-x-2 rounded-full border border-card-border bg-card-bg px-4 py-1.5 text-xs font-semibold">
            ...
            />
            <span className="text-foreground/90">Premium TV Packages Canada</span>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
        <div className="lg:col-span-7 space-y-4">
          <span className="text-xs font-bold uppercase tracking-wider text-primary">
            Canadian Sports & Hockey
          </span>
          <h2 className="text-2xl sm:text-3xl font-extrabold text-foreground tracking-tight">
            {country.localSportsTitle}
          </h2>
          <p className="text-sm sm:text-base text-foreground/75 leading-relaxed">
            {country.localSportsDesc} Stream NHL games, MLS games, Premier League matches, and winter sports events without regional blackout restrictions. Advanced CDN networks located near major Canadian cities ensure buffering stays at 0%.
          </p>
        ...
        <div className="lg:col-span-5 rounded-2xl border border-card-border bg-card-bg p-6 glass-panel space-y-4">
          <h3 className="font-bold text-base border-b border-card-border/60 pb-3">
            Canada ISP Peering Setup
          </h3>
          <p className="text-xs text-foreground/70 leading-relaxed">
            Optimized for major Canadian telecommunications networks:
          </p>
          <ul className="space-y-2 text-xs font-semibold text-foreground/85">
            <li>• Rogers Cable Broadband (UHD active)</li>
            <li>• Bell Fibe Internet (Direct peering, 0% drop rate)</li>
            <li>• Shaw Cable (Anti-freeze routing)</li>
            <li>• Telus Optik (Low-latency sports streams)</li>
            <li>• Cogeco & local providers (Full compatibility)</li>
          </ul>
        </div>
      </div>
      ...
      <div className="rounded-2xl bg-card-bg border border-card-border p-6 sm:p-8 glass-panel space-y-6">
        <div className="text-center max-w-xl mx-auto space-y-2">
          ...
          <p className="text-xs text-foreground/60">
            Set up is easy on all devices. Step-by-step documentation provided.
          </p>
        </div>
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-center">
          {["Smart TV (Samsung/LG)", "Amazon Firestick", "Android Box / Apple TV", "Windows / Mac PC"].map((d, i) => (
      ...
      <div className="text-center space-y-4 max-w-xl mx-auto">
        ...
        <p className="text-xs text-foreground/70 leading-relaxed">
          Select a package that meets your household requirements and send us a message on WhatsApp for credentials configuration.
        </p>
      ...
      <div className="space-y-6 max-w-3xl mx-auto">
        <h2 className="text-2xl font-bold text-foreground text-center">
          Canada IPTV Frequently Asked Questions
        </h2>
      ...
      {/* SEO Content Block */}
      <SEOContentBlock
        title="Best IPTV Packages in Canada for Live Sports & Hockey Broadcasting"
        description="Streaming live sports in Canada demands excellent server configurations. Our Canada IPTV guides provide custom routing parameters that work seamlessly with major local ISPs, ensuring stable playback on weekends and key matchdays. Contact support to verify available channel guides."
        keywords={[
          "premium IPTV packages Canada",
          "IPTV Canada",
          "IPTV Canada soccer",
      ...
      <div className="rounded-xl border border-card-border bg-card-bg/40 p-4 text-xs text-foreground/50 leading-relaxed flex gap-3">
        ...
        <div>
          <strong>Canadian Broadcaster Disclaimer:</strong> Broadcaster schedules, channel lineups, and hockey/soccer coverage depend on regional licensing. We assist with configuration and support files for authorized links. Contact support on WhatsApp to confirm details.
        </div>
      </div>
    </div>
  );
